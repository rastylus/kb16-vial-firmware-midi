...
// MIDI custom keycodes (CC 0-31)
enum custom_keycodes {
    MIDI_CC00 = SAFE_RANGE,
    MIDI_CC01, MIDI_CC02, MIDI_CC03, MIDI_CC04, MIDI_CC05, MIDI_CC06, MIDI_CC07,
    MIDI_CC08, MIDI_CC09, MIDI_CC10, MIDI_CC11, MIDI_CC12, MIDI_CC13, MIDI_CC14, MIDI_CC15,
};
...
*/
    /*  Row:    0         1        2        3         4      */
    [_BASE] = LAYOUT(
                MIDI_CC00, MIDI_CC01, MIDI_CC02, MIDI_CC03, KC_MPLY,
                MIDI_CC04, MIDI_CC05, MIDI_CC06, MIDI_CC07, TO(_FN),
                MIDI_CC08, MIDI_CC09, MIDI_CC10, MIDI_CC11, KC_MUTE,
                MO(_FN2), MIDI_CC12, MIDI_CC13, MIDI_CC14
            ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    if (keycode >= MIDI_CC00 && keycode <= MIDI_CC15) {
        if (record->event.pressed) {
            uint8_t cc = keycode - MIDI_CC00;  // CC 0-15
            midi_send_cc(&midi_device, 0, cc, 127);  // Channel 0, velocity 127
        }
        return false;
    }
    return true;
